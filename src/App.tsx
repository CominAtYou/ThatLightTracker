    ...
    <div className='flex flex-col h-full bg-neutral-200 dark:bg-neutral-900 transition duration-300'>
      <nav className='flex p-3.5 items-center justify-center border-b-[1px] border-neutral-300 dark:border-neutral-800 bg-[rgb(240_240_240)] dark:bg-[rgb(30_30_30)] transition duration-300'>
        <div className='flex items-center justify-center'>
            ...
            <span className='font-semibold select-none cursor-default dark:text-white transition duration-300'>{realmMetadata.find(x => x.id === selectedItem)?.name}</span>
        </div>
      </nav>
      <div className='flex flex-1 overflow-hidden'>
        <div className='lg:max-w-[325px] lg:min-w-[325px] h-full transition duration-300 px-4 pt-4 border-neutral-300 dark:border-neutral-800 border-r-[1px] flex-1 overflow-scroll'>
          <div className='mb-1'>
            <span className='ps-4 transition duration-300 font-semibold text-black/40 dark:text-white/40 text-xs uppercase select-none cursor-default'>Realms</span>
          </div>
