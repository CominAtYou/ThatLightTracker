    ...
    return (
        <div className="flex flex-col dark:shadow-xl shadow-xl rgba(153,153,153,1)] gap-1.5 bg-white dark:bg-neutral-700 p-4 rounded-xl max-w-[16rem] select-none cursor-default">
            ...
            <div className="flex flex-col gap-2">
                ...
                <button className="self-start text-sm justify-center text-blue-500 dark:text-[#4d90ff] bg-neutral-200 dark:bg-neutral-600 px-3 py-1 rounded-full font-semibold" onClick={onButtonClick}>{isCollected ? "Remove from Collected" : "Mark as Collected"}</button>
            </div>
        </div>
    )
}
